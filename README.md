...
Example Command:
python main.py --object_choice tile --threshold 0.004 --preprocess --train_model --plot_reconstructions --grid_size 8

To obtain the following results run the following commands: python main.py  --object_choice leather --load_model --threshold 0.006804

## Model result on tile dataset:
<img src="https://github.com/bcolmey/Anomaly-Detection-with-Deep-Learning-and-OpenCV/blob/main/Images/Tile_report.jpg" width="400" height="300">

## Model result on leather dataset:
<img src="https://github.com/bcolmey/Anomaly-Detection-with-Deep-Learning-and-OpenCV/blob/main/Images/Leather_report.jpg" width="400" height="300">
...
<img src="https://github.com/bcolmey/Anomaly-Detection-with-Deep-Learning-and-OpenCV/blob/main/Images/Objects.jpg" width="700" height="500">
